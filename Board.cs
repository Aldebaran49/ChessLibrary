...
{
    public class Board//хранит все активные фигуры
    {
        ...
        public static Board Initial()//создает доску со всеми фигурами пр стоящими
        {
            Board board = new Board();
            board.AddStartPieces();
            return board;
        }
        private void AddStartPieces()//начальные позиции
        {
        ...
        public static bool IsInside(Position pos)//проверяет позицию внутри доски
        {
            return pos.Row >= 0 && pos.Row <8 && pos.Column >= 0 && pos.Column < 8;
        }
        public bool IsEmpty(Position pos)//проверка пустоты клетки
        {
